...
function () {
  function Staction() {
    ...
    _classCallCheck(this, Staction);

    _defineProperty(this, "_hasBeenInitialized", void 0);

    _defineProperty(this, "_actions", void 0);

    _defineProperty(this, "_wrappedActions", void 0);

    _defineProperty(this, "_wrappedPrivateActions", void 0);

    _defineProperty(this, "_privateActions", void 0);

    _defineProperty(this, "_state", void 0);

    _defineProperty(this, "_stateSetCallback", void 0);

    _defineProperty(this, "_loggingEnabled", true);
    ...
    _defineProperty(this, "handleActionReturnTypes",
    /*#__PURE__*/
    function () {
    ...
    _defineProperty(this, "callSetStateCallback", function (newState) {
    ...
    _defineProperty(this, "disableLogging", function () {
      _this._loggingEnabled = false;
      return "Staction logging is disabled";
    });

    _defineProperty(this, "disableStateWhenLogging", function () {
      _this._addStateToLogs = false;
    });

    _defineProperty(this, "enableStateWhenLogging", function () {
      _this._addStateToLogs = true;
    });
  }

  _createClass(Staction, [{
    key: "init",
    value: function init(actions, initFunc, stateSetCallback) {
      try {
        if (!this._hasBeenInitialized) {
          ...
          this._wrappedActions = lodash_reduce__WEBPACK_IMPORTED_MODULE_1___default()(actions, this.wrapActions, {});
...
/* harmony default export */ __webpack_exports__["default"] = (Staction);

/***/ }),

/***/ 0:
/*!*******************************!*\
  !*** multi ./src/Staction.ts ***!
  \*******************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./src/Staction.ts */"./src/Staction.ts");
